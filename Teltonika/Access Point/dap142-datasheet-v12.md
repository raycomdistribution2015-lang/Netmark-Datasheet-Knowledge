...
**LAN** 2 x LAN ports, 10/100 Mbps, compliance with IEEE 802.3, IEEE 802.3u, 802.3az
...
**Network protocols** TCP, UDP, IPv4, IPv6, NTP, DNS, HTTP, HTTPS, FTP, SMTP, SSL/TLS, ARP, VRRP,

PPP, PPPoE, UPNP, SSH, DHCP, Telnet, SNMP, MQTT, Wake On Lan (WOL)
...
**PoE (passive)** Passive PoE over spare pairs. Possibility to power up through LAN2 port, not

compatible with IEEE802.3af, 802.3at and 802.3bt standards, Mode B, 9 - 30 VDC
...
**DAP142** **3-PIN POWER CONNECTOR** **QSG (QUICK START GUIDE)**
...
DAP142 0***** N/A DAP142000000 / Standard package
...
**DAP142 SPATIAL MEASUREMENTS**


**PHYSICAL SPECIFICATION**


**Device housing (W x H x D)*:** 113,10 x 25 x 68,6 mm


**Box (W x H x D):** 141 x 28,2 x 74,5 mm
