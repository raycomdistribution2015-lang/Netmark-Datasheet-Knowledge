...
(LTE) – LTE Cat 19 1.6Gbps DL, Cat 18 200Mbps UL; 3G – 42 Mbps DL, 5.76Mbps UL
...
**ETHERNET** 2 x ETH ports (can be configured as WAN), 10/100/1000 Mbps, compliance with IEEE

802.3, IEEE 802.3u, 802.3az standards, supports auto MDI/MDIX crossover
...
**PoE ports** 1 x PoE Out


**PoE standards** 802.3af Alternative B
...
**Power consumption** Idle: < 2.5 W / Max: < 9 W / PoE Max < 24 W
...
**Antennas specifications** 4 x 617 - 960 / 1695 - 2690 / 3300 - 4200 / 4200 - 5000MHz, 50 Ω, VSWR 3.5, gain

4.9 dBi, omnidirectional
...
**Standards** EN 55032:2015 + A11:2020 + A1:2020; EN 55035:2017 + A11:2020; EN IEC 61000-3-2:

2019 + A1:2021; EN 61000-3-3: 2013 + A1:2019 + A2:2021; EN 301 489-1 V2.2.3; EN
...
**OTD500 ROUTER** **ROUTER HOLDER** **QSG (QUICK START GUIDE)**
...
Packaging Box
 ...
 - Standard package contents are different for provided standard order codes.
...
**5G NR:** n1, n3, n5, n7, n8, n20, n28, n38, n40, n41,
...
**Device housing (W x H x D)*** 110 x 49.30 x 235 mm


**Box (W x H x D):** 110 x 51 x 235 mm
