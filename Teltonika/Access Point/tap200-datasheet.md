...
WPA2-EAP/WPA3-EAP Mixed Mode, WPA3-EAP, WPA2-PSK/WPA3-SAE Mixed Mode, WPA3-SAE, OWE, WPA-PSK/WPA2-PSK
Mixed Mode, WPA2-PSK, WPA2-EAP; AES-CCMP, TKIP, Auto Cipher modes, isolate clients
...
Network protocols TCP, UDP, IPv4, IPv6, ICMP, HTTP, HTTPS, SSL/TLS, ARP, SSH, DHCP client, SMNP
...
Standards EN 300 328 V2.2.2; EN 300 893 V2.1.1; EN 300 440 V2.2.1
...
TAP200 00300 851762 8517.62.00 Standard package with 15 W PoE Injector
...
## TAP200 SPATIAL MEASUREMENTS & WEIGHT

**MAIN MEASUREMENTS**


Dimensions for TAP200:
...
The figure below depicts the measurements of TAP200 and its components as seen from the top:


**BOTTOM VIEW**


The figure below depicts the measurements of TAP200 and its components as seen from the bottom side:
...
The figure below depicts the measurements of TAP200 and its components as seen from the front panel side:
