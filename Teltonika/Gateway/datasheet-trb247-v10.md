...
**Mobile module** 4G LTE Cat 1 bis up to 10 Mbps DL / 5 Mbps UL
...
**Network protocols** TCP, UDP, IPv4, IPv6, ICMP, NTP, DNS, HTTP, HTTPS, SFTP, FTP, SMTP(S), SSL/TLS,
...
**Input voltage range** 9 - 30 VDC, Reverse polarity protection, Surge protection


**Power consumption** Idle: < 1.7 W, Max: < 2.6 W
...
**Status LEDs** 1 x connection status LED, 3 x connection strength LEDs, 1 x power LED, 1 x Eth port
...
**Dimensions (W x H x D)** 83 x 25 x 82.6 mm
...
**TRB247** **2X8PIN CONNECTOR** **HEX KEY**
...
[2X8PIN Connector](https://teltonika-networks.com/products/accessories/other-2/2x8pin-connector)
...
**4G (LTE-FDD)** : B2, B4, B5, B12, B13, B14,

B66, B71



TRB247010000 / Standard package

without PSU

TRB247010200 / Mass packing code



**TRB247 SPATIAL MEASUREMENTS**
