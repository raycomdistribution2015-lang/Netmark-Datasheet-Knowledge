...
CE/RED, FCC, IC/ISED, EAC, RCM, PTCRB, RoHS, WEEE, Wi-Fi Certified, Anatel, GCF, REACH, Thailand NBTC, Ukraine UCRF, SDPPI
Regulatory
(POSTEL)
...
|ROUTER RUT240|9 W PSU|2 X LTE ANTENNAS (SWIVEL, SMA<br>MALE)|
|---|---|---|
|**1 X WIFI ANTENNA (SWIVEL, RP-SMA**<br>**MALE)**|**ETHERNET CABLE (1.5 M)**|**SIM ADAPTER KIT**|
...
RUT240 0DE000 851762 8517.62.00 Standard package with Euro PSU


RUT240 0AU000 851762 8517.62.00 Standard package with US PSU
...
Europe1, the Middle East, Africa, Korea, Thailand,
RUT240 *8****
India, Malaysia
...
- **2G:** B3, B8
                                                         ...
                                                         - **4G (LTE-FDD):** B1, B3, B7, B8, B20, B28A
Europe1, the Middle East, Africa, Korea,
RUT240 *6**** Thailand, Malaysia - **3G:** B1, B8
...
RUT240 *1**** North America (AT&T, Bell, T-Mobile)
...
RUT240 *A**** North America (Verizon, AT&T, T-Mobile)1
                                                         ...
                                                         - **4G (LTE-TDD):** B40
RUT240 *D**** Europe1, the Middle East, Africa
...
## RUT240 SPATIAL MEASUREMENTS & WEIGHT

**MAIN MEASUREMENTS**


W x H x D dimensions for RUT240:
...
The figure below depicts the measurements of RUT240 and its components as seen from the top:


**RIGHT VIEW**


The figure below depicts the measurements of RUT240 and its components as seen from the right side:
...
The figure below depicts the measurements of RUT240 and its components as seen from the front panel side:


**REAR VIEW**


The figure below depicts the measurements of RUT240 and its components as seen from the back panel side:
