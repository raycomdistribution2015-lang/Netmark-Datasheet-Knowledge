...
**Mobile module** 5G Sub-6Ghz SA 223 Mbps DL, 123 Mbps UL; 4G LTE Cat 4 – LTE 195 Mbps DL, 105
...
**Wireless Connectivity Features** Wireless mesh (802.11s), fast roaming (802.11r), BSS transition management (802.11v),
...
**WAN** 1 x WAN port 10/100 Mbps, compliance IEEE 802.3, IEEE 802.3u, 802.3az standards,

supports auto MDI/MDIX


**LAN** 3 x LAN ports, 10/100 Mbps, compliance IEEE 802.3, IEEE 802.3u standards, supports
...
**External devices** Possibility to connect external HDD, flash drive, printer, USB-serial adapter
...
**Input** 1 x digital dry input (0 - 3 V), 1 x digital galvanically isolated input (0 - 30 V), 1 x analog

input (0 - 24 V), 1 x Digital non-isolated input (on 4-pin power connector, 0 - 5 V

detected as logic low, 8 - 30 V detected as logic high)


**Output** 1 x digital open collector output (30 V, 250 mA), 1 x SPST relay output (40 V, 4 A), 1 x
...
**Applications** Samba share, Storage Memory Expansion, DLNA
...
**Power consumption** Idle: < 3 W, Max: < 7 W
...
**I/O’s** 2 x Inputs and 2 x Outputs on 10-pin industrial socket, 1 x Digital input and 1 x Digital

output on 4-pin power connector


**Status LEDs** 1 x Bi-color connection status, 5 x Mobile connection strength, 4 x ETH status, 1 x

Power


**SIM** 2 x SIM slots (Mini SIM - 2FF), 1.8 V/3 V, external SIM holders, eSIM (Optional 
different hardware required; contact your sales manager)
...
**Antennas** 2 x SMA for Mobile, 2 x RP-SMA for Wi-Fi, 1 x SMA for GNSS
...
**RUT976** **9W PSU** **2 X 5G MOBILE SMA ANTENNAS**


**2 X WI-FI MAGNETIC SMA ANTENNAS** **1 X GNSS ADHESIVE SMA ANTENNA** **CONNECTORS SET**


**ETHERNET CABLE (1.5M)** **SIM ADAPTER KIT** **QSG (QUICK START GUIDE)**


RUT976 router

[9 W PSU](https://teltonika-networks.com/products/accessories/powering-options/universal-power-supply-9w)

2x [5G Mobile antennas (swivel, SMA male)](https://teltonika-networks.com/products/accessories/antenna-options/5g-mobile-sma-antenna)

2x [Wi-Fi antennas (magnetic mount, RP-SMA male, 1.5 m cable)](https://teltonika-networks.com/products/accessories/antenna-options/wifi-magnetic-sma-antenna)

[GNSS antenna (adhesive, SMA male, 3 m cable)](https://teltonika-networks.com/products/accessories/antenna-options/gnss-adhesive-sma-antenna)

[RS485 connector block](https://teltonika-networks.com/products/accessories/other-2/connectors-set)

[I/O connector block](https://teltonika-networks.com/products/accessories/other-2/connectors-set)
...
**5G NR SA:** n1, n2, n3, n5, n7, n8, n12, n13, n14, n18,

n20, n25, n26, n28, n30, n38, n40, n41, n48, n66,

n70, n71, n77, n78, n79

**4G (LTE-FDD):** B1, B2, B3, B4, B5, B7, B8, B12, B13,

B14, B17, B18, B19, B20, B25, B26, B28, B30,
...
RUT976000000 / Standard

package with Universal PSU

RUT976000200 / Standard
...
**RUT976 SPATIAL MEASUREMENTS**


**PHYSICAL SPECIFICATION**


**Device housing (W x H x D)*** 110 x 50 x 100 mm


**Box (W x H x D):** 355 x 60 x 175 mm
