...
**Power consumption** Idle: 2.65 W, Max: 9.82 W
...
**Status LEDs** 3 x WAN type LEDs, 3 x Mobile connection type, 5 x Mobile connection strength, 8 x

LAN status, 1 x Power
...
**Antennas** 2 x SMA for Mobile, 1 x SMA for GNSS
...
**Standards** EN 301 908-1 V13.1.1
...
**RUTM09** **18W PSU** **2 X MOBILE SMA ANTENNAS**


**1 X GNSS ADHESIVE SMA ANTENNA** **ETHERNET CABLE (1.5M)** **SIM ADAPTER KIT**
...
[18 W PSU](https://teltonika-networks.com/products/accessories/powering-options/eu-power-supply-18w)

2x [Mobile antennas (swivel, SMA male)](https://teltonika-networks.com/products/accessories/antenna-options/mobile-sma-antenna)

1x [GNSS antenna (adhesive, SMA male, 3 m cable)](https://teltonika-networks.com/products/accessories/antenna-options/gnss-adhesive-sma-antenna)
...
Europe [1], the Middle East [1], Africa, Australia,
...
RUTM09000000 / Standard package with EU

PSU

RUTM09000300 / Standard package with AU

PSU

RUTM09000600 / Standard package with UK

PSU

RUTM09000100 / Mass packing code

RUTM09000400 / Standard package with Power

cable with 4-way screw terminal
