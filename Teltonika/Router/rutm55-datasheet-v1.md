...
**SIM switch** Dual SIM and eSIM, auto-switch cases: weak signal, data limit, SMS limit, roaming, no
...
**LAN** 3 x LAN ports, 10/100/1000 Mbps, compliance with IEEE 802.3, IEEE 802.3u, 802.3az
...
**Firewall** Pre-configured firewall rules can be enabled via WebUI, unlimited firewall

configuration via CLI; DMZ; NAT; NAT-T
...
**SSL certificate generation** Let's encrypt support
...
**RS232** Terminal block connector: TX, RX


**RS485** Terminal block connector: A,B(2 wire interface)
...
**Input** 1 x digital dry input (0 - 3 V), 1 x digital galvanically isolated input (0 - 50 V), 1 x analog

input (0 - 24 V)


**Output** 1 x Isolated open collector output (requires external voltage) (50 V, 500 mA), 1 x SPST

relay output (24 V, 10 A)
...
**PoE (passive)** Passive PoE over Port 1; 9-50VDC; "Mode B" style. Not compatible with 802.3af/at/bt.


**Power consumption** Idle: < 8.5 W, Max: < 14.5 W
...
**I/O’s** 1 x digital dry input, 1 x digital galvanically isolated input, 1 x analog input, 1 x Isolated

open collector output, 1 x SPST relay output


**Status LEDs** 3 x Mobile connection type, 3 x Mobile connection strength, 6 x LAN status, 1 x Power
...
**RS232** 2 pins in 16-pin terminal block


**RS485** 2 pins in 16-pin terminal block
...
**RUTM55** **3-PIN CONNECTOR** **16-PIN TERMINAL BLOCK**


**1 X HEX KEY** **SIM ADAPTER KIT** **QUICK START GUIDE**
...
**5G NR NSA:** n1, n3, n7, n38, n40, n41, n71, n77,

n78

**5G NR SA: 5G NR SA:** n1, n3, n7, n38, n40, n41,

n71, n77, n78

**4G (LTE-FDD):** B1, B3, B7, B38, B40, B41, B42,

B43, B71

**4G (LTE-TDD):** B1, B3, B7, B38, B40, B41, B42,
...
2 - For more detailed information about certified carriers, visit our [Wiki](https://wiki.teltonika-networks.com/view/Certificates#Americas.2C_Carrier.2C_and_Miscellaneous_table) page


**RUTM55 SPATIAL MEASUREMENTS**


**PHYSICAL SPECIFICATION**


**Device housing (W x H x D)*** 132 x 44.2 x 95.1 mm
...
The figure below depicts the measurements of device and its components as seen from the left:
